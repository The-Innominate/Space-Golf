...
public class ArrowGenerator : MonoBehaviour
{
	...
	void Start()
	{
		...
		pixelColor = new Color(PlayerPrefs.GetFloat("SelectedBallSkinR", 1f),
			PlayerPrefs.GetFloat("SelectedBallSkinG", 1f),
			PlayerPrefs.GetFloat("SelecedBallSkinB", 1f),
			1f);
	}
	...
	void GenerateArrow()
	{
		...
		mesh.SetColors(new Color[] { pixelColor, pixelColor, pixelColor, pixelColor, pixelColor, pixelColor, pixelColor });
